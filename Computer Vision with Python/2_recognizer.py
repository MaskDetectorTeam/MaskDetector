...
the 'database'. It writes down in the encodings.txt all encodings with names.
...
'''
For each file we downloaded before in the detection step, we resize it and
then we find all faces in it. For each face, we compare it to all know faces
to find which person/people is/are in it.
